  ...
  <div id="app">
        ...
        <footer class="footer">
            <div class="container-fluid footer-content">
                <button class="btn-buttom btn-buttom-info"><a href="javascript:location.reload();" style="color: #eeeeee;text-decoration: none">DEMO VERSION 1.0.0</a></button><button class="btn-buttom btn-buttom-info" style="margin-left:5px;"><a href="https://vercel.com?utm_source=oruyanke" style="color: #eeeeee;text-decoration: none"><img src="/resources/vercel.svg" style="height:13px;"></a></button>
                <div class="pull-left">
